...
///Wrong Rental Code exception messages is provided here
class WrongRentalCodeException extends PaymentException {
  WrongRentalCodeException.init(String message) : super.init(message);
}
